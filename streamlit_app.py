        ...
        with col:
            for row_index in range(7):
                ...
                with st.expander(question):  # Use the question as the expander label
                    ...
                    answer = st.text_input(f"{question}", key=f"q{col_index}{row_index}",value=st.session_state.answers[row_index][col_index],placeholder="Answer Here",label_visibility="hidden")
